    ...
    <body>
        ...
        <script>
            function loguear(){
                ...
                if (usuario.length == 0) { toastr.warning('Incorrect user', '', {"positionClass": "toast-top-center"}); return;}
                if (password.length == 0) { toastr.warning('Incorrect password', '', {"positionClass": "toast-top-center"}); return;}
                $.ajax({
                    url: 'C_login/login',
                    type: 'POST',
                    data: {
